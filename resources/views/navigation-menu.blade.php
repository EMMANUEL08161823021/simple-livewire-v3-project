<nav x-data="{ open: false }" class="dark:bg-gray-800 dark:border-gray-700 fixed bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl sm:px-6 lg:px-8 px-4 mx-auto">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <x-application-mark class="h-9 block w-auto" />
                    </a>
                </div>
            ...
            <div class="sm:flex sm:items-center sm:ml-6 hidden">
                ...
                <livewire:megaphone :polling="true" :notifiable="\App\Models\User::find(3)"></livewire:megaphone>
                        ...
                        <x-dropdown align="right" width="60">
                            <x-slot name="trigger">
                                <span class="inline-flex rounded-md">
                                    <button type="button" class="dark:text-gray-400 dark:bg-gray-800 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none focus:bg-gray-50 dark:focus:bg-gray-700 active:bg-gray-50 dark:active:bg-gray-700 inline-flex items-center px-3 py-2 text-sm font-medium leading-4 text-gray-500 transition duration-150 ease-in-out bg-white border border-transparent rounded-md">
